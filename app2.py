...
MODEL = tf.keras.models.load_model("C:/Users/ASUS/Coding Ninjas/model/potato_api.h5")
...
def predict():
    ...
    class_indices = {0: 'Potato__Early_blight', 1: 'Potato__healthy', 2: 'Potato__Late_blight'}
